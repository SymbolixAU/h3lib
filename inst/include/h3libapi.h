...
// H3Error  compactCells( const H3Index *h3Set, H3Index *compactedSet, const int64_t numHexes );
// H3Error  uncompactCellsSize( const H3Index *compactedSet, const int64_t numCompacted, const int res, int64_t *out );
// H3Error  uncompactCells( const H3Index *compactedSet, const int64_t numCompacted, H3Index *outSet, const int64_t numOut, const int res );
...
// H3Error  cellToVertexes( H3Index origin, H3Index *vertexes );
